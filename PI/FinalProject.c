...
int imprimeReservaciones(void)
{
    ...
    printf("Estas son las reservaciones que se han hecho en exterior o albercada:");
    printf("\n");
    ...
    printf("Estas son las reservaciones que se han hecho en salon cerrado:");
    printf("\n");
    while (!feof(fichero))
    {
        c = getc(fichero);
...
int eliminar(void) 
{
    ...
    rewind(fileptr1);
    printf("Para eliminar un evento, debe escogerlo dependiendo de la linea donde este:\n");
    scanf("%d", &delete_line);
    ...
    printf("El evento ha sido eliminado. Ahora, estos son los eventos del salon programados:\n");
